class PizzaChita (
...
), ProsmotrChacky, Coffi,SousOpeca{
    ...
    override fun offerSous(){
        ...
        if (c == "1") {
            ...
            println("С вас 50 рублей за соус\n")
            ...
            println("С вас 65 рублей за соус\n")
            when{
    ...
    override fun neapolitanPizzaSale() {
        ...
        println("Спасибо за покупку неаполитической пиццы в Чите")
    }

    override fun romanPizzaSale() {
        romanPizzaCount++
        println("Спасибо за покупку римской пиццы в Чите")
    }

    override fun sicilianPizzaSale() {
        sicilianPizzaCount++
        println("Спасибо за покупку сицилийской пиццы в Чите")
    }

    override fun tyroleanPizzaSale() {
        tyroleanPizzaCount++
        println("Спасибо за покупку Тирольской пиццы в Чите")
    }
